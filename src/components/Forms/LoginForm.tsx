        ...
        <div className="hidden w-full xl:block xl:w-1/2">
          <div className="px-26 py-17.5 text-center">
            ...
            <span className="mt-15 inline-block">
              ...
              >
                <path
                  id="fa3b9e12-7275-481e-bee9-64fd9595a50d-346"
                  data-name="Path 1"
                ...
                />
                <path
                  id="bde08021-c30f-4979-a9d8-cb90b72b5ca2-347"
                  data-name="Path 2"
                ...
                />
                <path
                  id="b3ac2088-de9b-4f7f-bc99-0ed9705c1a9d-348"
                  data-name="Path 22"
                ...
                />
                <path
                  id="b2715b96-3117-487c-acc0-20904544b5b7-349"
                  data-name="Path 23"
                ...
                />
                <path
                  id="b06d66ec-6c84-45dd-8c27-1263a6253192-350"
                  data-name="Path 6"
                ...
                />
                <path
                  id="e73810fe-4cf4-40cc-8c7c-ca544ce30bd4-351"
                  data-name="Path 7"
                ...
                />
                <path
                  id="bbe451c3-febc-41ba-8083-4c8307a2e73e-352"
                  data-name="Path 8"
                ...
                />
                <path
                  id="f1094013-1297-477a-ac57-08eac07c4bd5-353"
                  data-name="Path 88"
                ...
                />
                <path
                  id="ae7af94f-88d7-4204-9f07-e3651de85c05-354"
                  data-name="Path 99"
                ...
                />
                <path
                  id="a6768b0e-63d0-4b31-8462-9b2e0b00f0fd-355"
                  data-name="Path 101"
                ...
                />
                <path
                  id="bfd7963f-0cf8-4885-9d3a-2c00bccda2e3-356"
                  data-name="Path 102"
            ...
            <form>
              ...
              <div className="mb-5">
                <input
                  type="submit"
                  value="Sign In"
                  className="w-full cursor-pointer rounded-lg border border-green-500 bg-green-500 p-4 text-white transition hover:bg-opacity-90"
                />
              </div>
            </form>
          </div>
